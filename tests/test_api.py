...
@pytest.fixture
def client_with_mock_orchestrator() -> Generator[TestClient, None, None]:
...
def test_health_endpoint(client_with_mock_orchestrator: TestClient) -> None:
...
def test_chat_endpoint_flow(client_with_mock_orchestrator: TestClient) -> None:
